#Open Galileo – Advanced stacking of scientific and macro images
#Open Galileo is a free and open-source program developed
#by Brandon Antonio Segura Torres @micro.cosmonauta, designed for
#image stacking (focus stacking) and advanced signal integration,
#aimed at scientific photography, microscopy, macro photography,
#astrophotography, and high-precision technical documentation.
#The software allows multiple images of the same scene to be combined to
#achieve maximum sharpness, extended depth of field, and noise reduction,
#even when each individual image has out-of-focus areas or very low signal.
...
#Rest of the world via PayPal: [antoniovangritte@gmail.com](mailto:antoniovangritte@gmail.com)
...
class FocusStackerApp(tk.Tk):
    def __init__(self):
        ...
        def _startup():
            ...
            self.title("Open Galileo v1.0 / Program developed by Brandon Antonio Segura Torres / @micro.cosmonauta / antoniosegura3d@gmail.com")
            ...
            self.auto_save_label_var = tk.StringVar(value="Automatic saving: (not selected)")
    ...
    def _build_ui(self):
        ...
        ToolTip(self.btn_add, "Add image series to the stack")
        ...
        ToolTip(self.btn_save, "Select a path for automatic file saving")
        ...
        DisabledToolTip(
            ...
            'To use these sliders, enable the “PMax” method (check the PMax box).'
        )
        DisabledToolTip(
        ...
        DisabledToolTip(
            ...
            'To use these sliders, enable the “Weighted average” method (check the Weighted average box).'
        )
        DisabledToolTip(
        ...
        DisabledToolTip(
            ...
            'To use these sliders, enable the “Depth map” method (check the Depth map box).'
        )
        DisabledToolTip(
        ...
        _tt_mean = 'To use these sliders, enable the “Average (mean stacking)” method (check the Average box).'
        ...
        _tt_median = 'To use these sliders, enable the “Median (median stacking)” method (check the Median box).'
        ...
        _tt_sum = 'To use these sliders, enable the “Sum (sum stacking)” method (check the Sum box).'
        ...
        _tt_sigma = 'To use these sliders, enable the “Sigma-clipping” method (check the Sigma-clipping box).'
        ...
        _tt_bm3d = 'To use these sliders, enable the “BM3D” filter (check the BM3D box).'
        ...
        _tt_bil = 'To use these sliders, enable the “Bilateral” filter (check the Bilateral box).'
        ...
        _tt_wav = 'To use this slider, enable the “Wavelet Denoising” filter (check the Wavelet box).'
        ...
        _tt_nlm = 'To use these sliders, enable the “Non-Local Means” filter (check the NLM box).'
        ...
        _tt_four = 'To use these sliders, enable the “Fourier filtering” filter (check the Fourier filtering box).'
        ...
        _tt_n2v = 'To use these sliders, enable the “Noise2Noise / Noise2Void” filter (check the Noise2Noise / Noise2Void box).'
        ...
        _tt_med = 'To use this slider, enable the “Median filter” filter (check the Median filter box).'
        ...
        _tt_gau = 'To use these sliders, enable the “Gaussian filter” filter (check the Gaussian filter box).'
    ...
    def _show_bm3d_warning(self):
        msg = (
            "This filter may take up to 15 minutes per image.\n\n"
            "BM3D (Block-Matching 3D) is an advanced, CPU/RAM-intensive denoiser, "
    ...
    def _update_autosave_label(self):
        if self.auto_save_dir:
            ...
            self.auto_save_label_var.set("Automatic saving: (not selected)")
    ...
    def show_about(self):
        about_text = (
            ...
            "microscopy, macro photography, astrophotography, and high-precision technical documentation.\n"
            "The software allows multiple images of the same scene to be combined to achieve\n"
            ...
            "It is free, without restrictions, and designed to grow with the community.\n"
            "Open Galileo is and always will be free.\n"
            "If you find this program useful and wish to support the time, effort, and research\n"
    ...
    def ensure_calibration_loaded(self):
        ...
        info = (
            ...
            " - Dark: black background, same exposure/ISO as the sky images.\n"
        ...
        make_row(
            body,
            "dark",
            "Master Dark (dark field)",
            "Sensor thermal noise. Same exposure/ISO as the lights, lens/cap covering the light entrance.",
        )
        make_row(
            body,
            "flat",
            "Master Flat (flat field)",
            "Corrects vignetting and dust spots. Uniform sky / illuminated panel, same position and focus as the lights.",
        )
        make_row(
            body,
            "bias",
    ...
    def apilar_imagenes(self):
        ...
        if has_raw:
            messagebox.showwarning(
                ...
                "Processing RAW images involves full sensor decoding "
                "and intensive CPU and memory usage.\n\n"
                "During this stage the program may appear unresponsive, "
                "but processing continues in the background.\n\n"
                "Do not close the application and allow the process to finish."
